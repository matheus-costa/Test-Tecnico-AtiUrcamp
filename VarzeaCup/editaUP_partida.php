<?php
$sql = " update partida set timeA = '" . $_REQUEST['timeA'] . "', timeB = '" . $_REQUEST['timeB'] . "',golstimeA = '" . $_REQUEST['golstimeA'] . "',golstimeB = '" . $_REQUEST['golstimeB'] . "',horaP = '".$_REQUEST['horaP'] . "',dataP = '".$_REQUEST['dataP'].  "' where id = '" . $_REQUEST['id'] . "' "; //aqui eu recebo o ID de qual elemento vou alterar 
